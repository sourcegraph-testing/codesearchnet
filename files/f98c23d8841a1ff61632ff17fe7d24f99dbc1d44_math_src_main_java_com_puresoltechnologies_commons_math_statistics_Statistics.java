...
public class Statistics implements Serializable {
    ...
    private Statistics(int count, double min, double max, double avg, Double median, Double stdDev) {
	this.count = count;
	this.min = min;
	this.max = max;
	this.avg = avg;
	...
	double avg = (leftCount * left.getAvg() + rightCount * right.getAvg()) / (leftCount + rightCount);
